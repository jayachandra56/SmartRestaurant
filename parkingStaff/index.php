...
if(isset($_SESSION['logged'])){
    echo "<script>window.location=\"parkingDashboard.php\"</script>";
}
?>
<html>
<head>
...
<body style="background:url(../images/main.jpg);background-position: inherit;
...
<div class="header text-center"><h1>parking Login</h1></div>
    <div class="UserForm">
        ...
        <?php
            if(isset($_POST['login']))
            {
                ...
                if($row!=null && $row['password']=== $password){
                    ...
                    header( "Location: http://localhost:8080/smartRestaurant/parkingStaff/parkingDashboard.php" );
                    $_SESSION['logged']=1; 
                    die;
                }
                else{
