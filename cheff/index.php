...
if(isset($_SESSION['logged'])){
    echo "<script>window.location=\"cheffDashboard.php\"</script>";
}
?>
<html>
<head>
...
<div class="header text-center"><h1>Cheff Login</h1></div>
    <div class="UserForm">
        ...
        <?php
            if(isset($_POST['login']))
            {
                ...
                if($row!=null && $row['password']=== $password){
                    ...
                    header( "Location: http://localhost:8080/smartRestaurant/cheff/cheffDashboard.php" );
                    $_SESSION['logged']=1; 
                    die;
                }
                else{
