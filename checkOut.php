...
<div class="list-group-item" style="background-color:#ce1e1e;">
            ...
            <h4 id="heading-status">Price</h4>
            <h4 id="heading-qty">Qty</h4>
            <h4 id="heading-status">Total</h4>
            ...
            $comp=new mainMenuComponent();
                ...
                if($result!=null){
                    ...
                    while($row=mysqli_fetch_assoc($result)){
                        $comp->checkOutItemComponent($row["itemName"],$row["itemID"],$row["quantity"],$row['price']);
                    ...
                    <div class=\"list-group-item\" style=\"background-color:#ce1e1e;color:#fff;\">
                        <div style=\"display:flex;justify-content:flex-end;\">
                            <h3 id=\"heading-name\">Subtotal :</h3>
                            <h3 id=\"heading-name\" style=\"color:#fff;\">$total</h3>
                        </div> 
                        <div style=\"display:flex;justify-content:flex-end;\">
                            <h3 id=\"heading-name\">GST(18%) :</h3>
                            <h3 id=\"heading-name\" style=\"color:#fff;\">$gst</h3>
                        </div> 
                        <br>
                        <div style=\"width:100%;border:1px solid #fff\">
                        </div> <br>
                        <div style=\"display:flex;justify-content:flex-end;\">
                            <h3 id=\"heading-name\">Total Amount :</h3>
                            <h3 id=\"heading-name\" style=\"color:#fff;\">$finalAMT</h3>
                        </div>  
                        <hr>
                        <form method=\"post\" action=\"payment/payment.php\">

                            <input type=\"hidden\" value=\"$finalAMT\" name=\"amount\">
                            <center><button name=\"payment-btn\" style=\"background-color: #ce1e1e;padding:10px;border-radius:15px;border-color: bisque;color: #FFF;\"><h5 style=\"color:#fff\">Make Payment</h5></button></center>  <hr> 
                             <br><br><br>
                        </form>
